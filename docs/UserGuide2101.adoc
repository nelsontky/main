...
.Hi! I'm Stasher, the mascot of Coupon Stash.
image::ug_stasher.png[width=30%]
...
for you to try out too! Also, take note of the general format of all the commands below!
...
* `archive 1` +
Archives the first coupon in Coupon Stash.
...
* `unarchive 1` +
Unarchive the first coupon in Coupon Stash.
// end::unarchive[]
...
image::ShareDownload.png[width="50%"]

. Click save, and the image will be saved into the specified folder.

. Share this image with your friends and family!
+
.Example of a shared coupon.
image::GrabFoodCoupon.png[width="75%"]
...
image::expand_example.png[width="80%"]
// end::expand[]
...
remind date is 3 days before the stated expiry date:
+
...
. Suppose you ran these 3 commands in order:
* `edit 1 n/ Adidas 31 Percent`
+
.Before running the `edit` command.
image::keyboard_shortcuts/updownedit.png[width="75%"]
+
{empty} +
{empty} +
{empty} +
...
image::keyboard_shortcuts/updownarchive.png[width="75%"]
...
image::keyboard_shortcuts/updownadd.png[width="75%"]
+
{empty} +
{empty} +
{empty} +
...
image::keyboard_shortcuts/updownwrongname.png[width="75%"]
...
image::keyboard_shortcuts/updownretrivee.png[width="75%"]
{empty} +
{empty} +
{empty} +
{empty} +
...
image::keyboard_shortcuts/updownchangedname.png[width="75%"]
+
.Adidas coupon amended successfully.
image::keyboard_shortcuts/updownfinal.png[width="75%"]
...
shortcut also works for closing <<Reminding of coupon expiry (Kevin), reminder>>
windows.
