...
. You will see a message in the <<UserInterface, Command Result Box>> indicating that the third coupon has been copied
to your clipboard.
+
.Example of result message of the `copy` command.
image::UG_copy_7.png[width=50%]

. You can now kbd:[Ctrl] + kbd:[V] to paste it (kbd:[Cmd] + kbd:[V] for macOS) into any messaging platform/ application
to share it.
+
